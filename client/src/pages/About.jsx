            ...
            <div className="container relative-z">
                ...
                <div className="about-header-grid mb-5">
                        ...
                        <TiltCard>
                            <div className="about-avatar-scene">
                                ...
                                <div className="about-floating-badge badge-top">
                                    <i className="fas fa-code" style={{ color: 'var(--primary)', marginRight: '8px' }}></i> Software Eng.
                                </div>
                                <div className="about-floating-badge badge-bottom">
                                    <i className="fas fa-map-marker-alt" style={{ color: 'var(--secondary)', marginRight: '8px' }}></i> Jimma, ET
                                </div>
                            </div>
                        </TiltCard>
                    </div>
                    ...
                    <div className="about-bio-col reveal" style={{ transitionDelay: '0.2s' }}>
                        <span className="section-chip"><i className="fas fa-user" style={{ marginRight: '6px', opacity: 0.7 }}></i>{t('about', 'title') || 'About Me'}</span>
                        <h2 className="about-title">
                            Girma Ashetu <span className="text-gradient">Asefa</span>
                        </h2>
                        <h4 className="about-subtitle">{t('about', 'subtitle') || 'Software Engineering Student'}</h4>
                ...
                <div className="about-stats-strip mb-5 reveal-up">
                    <div className="about-stat-card">
                        <div className="stat-icon"><i className="fas fa-graduation-cap"></i></div>
                        <div className="stat-info">
                            <span className="stat-value">B.Sc. Degree</span>
                            <span className="stat-label">Software Engineering Student</span>
                        </div>
                    </div>
                    <div className="about-stat-card">
                        <div className="stat-icon" style={{ color: 'var(--secondary)' }}><i className="fas fa-code-branch"></i></div>
                        <div className="stat-info">
                            <span className="stat-value">10+ Projects</span>
                            <span className="stat-label">Full-Stack & Mobile Apps</span>
                        </div>
                    </div>
                    <div className="about-stat-card">
                        <div className="stat-icon" style={{ color: 'var(--accent)' }}><i className="fas fa-certificate"></i></div>
                        <div className="stat-info">
                            <span className="stat-value">6+ Pursued</span>
                            <span className="stat-label">Verified Certifications</span>
                        </div>
                    </div>
                    <div className="about-stat-card">
                        <div className="stat-icon" style={{ color: 'var(--warning)' }}><i className="fas fa-shield-alt"></i></div>
                        <div className="stat-info">
                            <span className="stat-value">100% Quality</span>
                            <span className="stat-label">Clean Code & Security Focus</span>
                        </div>
                    </div>
                </div>
